  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 animate-fadeSlideUp">
...
>
  Assinar Agora
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Saúde, confiança e autoestima renovadas — veja alguns exemplos reais.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            <img className="rounded-2xl shadow-lg h-80 w-full object-cover" src="/results/woman1.webp" />
            <img className="rounded-2xl shadow-lg h-80 w-full object-cover" src="/results/woman2.webp" />
            <img className="rounded-2xl shadow-lg h-80 w-full object-cover" src="/results/woman3.webp" />
          </div>

          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            Resultados variam por pessoa. O importante é começar.
          </p>
        </div>
      </section>
      ...
      <style jsx global>{`
        ...
        .animate-fadeSlideUp { animation: fadeSlideUp 0.8s ease forwards; }
        .delay-200 { animation-delay: 0.2s; }

        h1, h2, h3 { transition: color 0.3s ease; }
        h1:hover, h2:hover, h3:hover { color: #6ECBF5; }

        a, button { transition: 0.25s ease-in-out; }
      `}</style>
    </div>
  );
}
