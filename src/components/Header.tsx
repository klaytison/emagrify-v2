        ...
        <nav className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-[#2A2A2A] dark:text-white">
                Emagrify
              </span>
            </div>
            ...
            {loading ? (
              ...
              <>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="w-56 bg-white dark:bg-[#2A2A2A] border-[#F4F4F4] dark:border-gray-700"
                  >
                    ...
                    <DropdownMenuItem
                      ...
                      className="text-[#2A2A2A] dark:text-white hover:bg-[#7BE4B7]/10"
                    >
                    ...
                    {isAdmin && (
                      <DropdownMenuItem
                        onClick={() => handleNavigation("/admin")}
                        className="text-[#FF7A00] dark:text-[#FF7A00] hover:bg-[#FF7A00]/10"
                      >
                        <LayoutDashboard className="w-4 h-4 mr-2" />
                        Painel Admin
                      </DropdownMenuItem>
